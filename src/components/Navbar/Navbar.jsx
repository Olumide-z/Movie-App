    ...
    <Container>
      ...
      <NavIcons>
        ...
        <Icon to="/watchlist">
          <BsBookmarkStar />
          {watchlist.length ? (
            <div className="watchlist-numbers">{watchlist.length}</div>
          ) : null}
        </Icon>
        <BarsContainer onClick={() => setSidebarStatus(!sidebarStatus)}>
          {sidebarStatus ? <Times></Times> : <Bars></Bars>}
        </BarsContainer>
      </NavIcons>
